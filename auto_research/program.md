...
- use this fixed slice until a newer canonical evaluation slice is explicitly
  approved
- do not silently roll the decision end date past `2026-05-07` inside this
  session
...
- stale `1 USD / max3` or stale pre-`2026-05-07` frozen windows
...
6. If a current `reversal` near-40 suite spec is missing for the current
   `2 USD / max5 / 2026-05-07` judge, create or update it from the nearest
