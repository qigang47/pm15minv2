...
export PROGRAM_PATH="${PROGRAM_PATH:-$ROOT_DIR/auto_research/program_reversal_dense_sol_xrp.md}"
export SESSION_DIR="${SESSION_DIR:-$ROOT_DIR/sessions/deep_otm_baseline_reversal_dense_sol_xrp_autoresearch}"
export AUTORUN_DIR="${AUTORUN_DIR:-$ROOT_DIR/var/research/autorun/reversal_dense_sol_xrp}"
