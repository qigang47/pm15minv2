...
`direction` line in `xrp`-only mode.

## Canonical References

- Active session:
  `sessions/deep_otm_baseline_direction_dense_xrp_autoresearch/session.md`
- Active results log:
  `sessions/deep_otm_baseline_direction_dense_xrp_autoresearch/results.tsv`
