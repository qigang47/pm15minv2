...
export PM15MIN_BACKTEST_SURFACE_RUNTIME_CACHE_MAX_ENTRIES="${PM15MIN_BACKTEST_SURFACE_RUNTIME_CACHE_MAX_ENTRIES:-2}"
export PM15MIN_QUICK_SCREEN_SHARED_SURFACES="${PM15MIN_QUICK_SCREEN_SHARED_SURFACES:-1}"
...
export PM15MIN_QUICK_SCREEN_POOL_WORKERS="${PM15MIN_QUICK_SCREEN_POOL_WORKERS:-10}"
export PM15MIN_QUICK_SCREEN_POOL_MAX_ITEMS="${PM15MIN_QUICK_SCREEN_POOL_MAX_ITEMS:-10}"
export PM15MIN_QUICK_SCREEN_POOL_MEMORY_REPORT_INTERVAL_SEC="${PM15MIN_QUICK_SCREEN_POOL_MEMORY_REPORT_INTERVAL_SEC:-60}"
...
SCRIPT_PATH="${PM15MIN_QUICK_SCREEN_POOL_SCRIPT:-$ROOT_DIR/scripts/research/run_quick_screen_pool.py}"
exec "$PYTHON_BIN" "$SCRIPT_PATH" "$@" \
  --workers "$PM15MIN_QUICK_SCREEN_POOL_WORKERS" \
  --max-items "$PM15MIN_QUICK_SCREEN_POOL_MAX_ITEMS" \
  --memory-report-interval-sec "$PM15MIN_QUICK_SCREEN_POOL_MEMORY_REPORT_INTERVAL_SEC"
