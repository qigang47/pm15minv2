...
def attach_live_subcommands(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    runner_loop.add_argument("--iterations", type=int, default=1, help="Max loop iterations; use 0 to run forever.")
    ...
    redeem_loop.add_argument("--iterations", type=int, default=1, help="Max loop iterations; use 0 with --loop to run forever.")
