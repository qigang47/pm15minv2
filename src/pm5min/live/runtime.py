...
from pm5min.research.service import get_active_bundle_selection
...
DEFAULT_LIVE_PROFILE_SPEC = LiveProfileSpec(
    profile="default",
    target="direction",
...
def resolve_live_profile_spec(profile: str) -> LiveProfileSpec:
    ...
    return LIVE_PROFILE_SPECS.get(token, DEFAULT_LIVE_PROFILE_SPEC)
...
def describe_live_profile_resolution(*, cfg: LiveConfig, profile_spec: LiveProfileSpec) -> dict[str, object]:
