...
def normalize_target(target: str) -> str:
    ...
    try:
        ...
        raise ValueError(f"Unsupported target {target!r}. Expected one of: direction, reversal") from exc
...
def normalize_source_surface(surface: str) -> str:
    ...
    try:
        ...
        raise ValueError(f"Unsupported source surface {surface!r}. Expected one of: live, backtest") from exc
