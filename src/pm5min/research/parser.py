...
def attach_research_subcommands(
    ...
    add_profile_arg(show_active_bundle, default="deep_otm_5m")
    ...
    add_profile_arg(activate_bundle, default="deep_otm_5m")
    ...
    train_run.add_argument("--offsets", default="2,3,4")
    ...
    add_profile_arg(bundle_build, default="deep_otm_5m")
    bundle_build.add_argument("--model-family", default="deep_otm")
    add_target_arg(bundle_build)
    bundle_build.add_argument("--offsets", default="2,3,4")
    ...
    add_profile_arg(backtest_run, default="deep_otm_5m")
