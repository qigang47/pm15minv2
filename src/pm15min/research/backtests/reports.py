...
def render_backtest_report(
    ...
    *,
    ...
    lines = [
        ...
        f"- decision_quote_candidate_total_rows: `{summary.get('decision_quote_candidate_total_rows', 0)}`",
        f"- decision_quote_candidate_examined_rows: `{summary.get('decision_quote_candidate_examined_rows', 0)}`",
        f"- decision_quote_signal_rows: `{summary.get('decision_quote_signal_rows', 0)}`",
        f"- decision_quote_signal_candidate_total_rows: `{summary.get('decision_quote_signal_candidate_total_rows', 0)}`",
        f"- decision_quote_signal_candidate_examined_rows: `{summary.get('decision_quote_signal_candidate_examined_rows', 0)}`",
        f"- decision_quote_signal_candidate_orderbook_missing_rows: `{summary.get('decision_quote_signal_candidate_orderbook_missing_rows', 0)}`",
        f"- decision_quote_signal_candidate_price_reject_rows: `{summary.get('decision_quote_signal_candidate_price_reject_rows', 0)}`",
        f"- decision_quote_signal_candidate_depth_reject_rows: `{summary.get('decision_quote_signal_candidate_depth_reject_rows', 0)}`",
        f"- decision_quote_signal_candidate_fillable_rows: `{summary.get('decision_quote_signal_candidate_fillable_rows', 0)}`",
