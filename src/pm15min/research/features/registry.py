...
_FEATURES = (
    ...
    FeatureDefinition("minutes_left_to_settle", "cycle", "Minutes remaining until cycle settlement"),
    ...
    FeatureDefinition("up_move_remaining_per_minute", "strike", "Required upward move per remaining minute to finish above strike"),
    FeatureDefinition("up_move_remaining_z_per_minute", "strike", "Required upward move per remaining minute normalized by rv_30"),
    FeatureDefinition("first_up_cross_offset", "strike", "Offset of the first observed up-side strike cross in the current cycle"),
    FeatureDefinition("minutes_since_first_up_cross", "strike", "Minutes elapsed since the first observed up-side strike cross"),
    FeatureDefinition("up_hold_minutes", "strike", "Length of the current consecutive up-side strike hold streak"),
