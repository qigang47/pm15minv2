...
_STAGE_LABELS = {
    ...
    "bundle_replay": "模型回放",
    "depth_replay": "订单簿回放",
    "runtime_surface": "运行时表面",
    "quote_surface": "盘口报价",
    "live_state_surface": "实盘状态",
    "policy_decisions": "策略决策",
    "secondary_decisions": "次模型决策",
    "fills_materialization": "成交构造",
    "settlement_summary": "结算汇总",
    "write_outputs": "写入产物",
    "training_prepare": "训练准备",
    "training_oof": "OOF 训练",
    "training_offsets": "训练 offsets",
    "training_artifacts": "训练产物写入",
    "training_finalize": "训练收尾",
    "experiment_suite": "实验套件",
    "experiment_group": "实验分组",
    "experiment_group_warmup": "实验分组预热",
    "experiment_group_parallel": "实验分组并行执行",
    "experiment_cases": "实验案例",
    "experiment_case_detail": "实验案例详情",
    "suite_dispatch": "实验调度",
    "suite_group": "实验分组",
    "suite_case": "实验案例",
    "suite_finalize": "实验收尾",
