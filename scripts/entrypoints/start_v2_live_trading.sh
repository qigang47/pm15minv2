...
Env overrides:
  ...
  PM15MIN_LIVE_FEATURE_INCREMENTAL_BUILD_TAIL_BARS default: 320
  ...
  PM15MIN_LIVE_ENFORCE_EXPECTED_CLOSED_BAR  default: 1
  PM15MIN_LIVE_EXPECTED_CLOSED_BAR_WAIT_SEC default: 1.5
  PM15MIN_LIVE_EXPECTED_CLOSED_BAR_POLL_SEC default: 0.05
  PM15MIN_LIVE_DECISION_DEPTH_ENFORCED      default: 1
  PM15MIN_RUNNER_SIGNAL_PREWARM_MIN_DELAY_SEC default: 0
  PM15MIN_RUNNER_SIGNAL_PREWARM_MAX_DELAY_SEC default: 3
  PM15MIN_RUNNER_SIGNAL_PREWARM_FINALIZE_CLOSED_BAR_WAIT_SEC default: 1.5
  PM15MIN_RUNNER_SIGNAL_PREWARM_FINALIZE_RETRY_INTERVAL_SEC default: 0.05
  PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_MIN_DELAY_SEC default: 57
  PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_MAX_DELAY_SEC default: 59.9
  PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_FINALIZE_BRIDGE_SEC default: 4.0
...
export PM15MIN_LIVE_FEATURE_INCREMENTAL_BUILD_TAIL_BARS="${PM15MIN_LIVE_FEATURE_INCREMENTAL_BUILD_TAIL_BARS:-320}"
...
export PM15MIN_LIVE_ENFORCE_EXPECTED_CLOSED_BAR="${PM15MIN_LIVE_ENFORCE_EXPECTED_CLOSED_BAR:-1}"
export PM15MIN_LIVE_EXPECTED_CLOSED_BAR_WAIT_SEC="${PM15MIN_LIVE_EXPECTED_CLOSED_BAR_WAIT_SEC:-1.5}"
export PM15MIN_LIVE_EXPECTED_CLOSED_BAR_POLL_SEC="${PM15MIN_LIVE_EXPECTED_CLOSED_BAR_POLL_SEC:-0.05}"
export PM15MIN_LIVE_DECISION_DEPTH_ENFORCED="${PM15MIN_LIVE_DECISION_DEPTH_ENFORCED:-1}"
export PM15MIN_RUNNER_SIGNAL_PREWARM_MIN_DELAY_SEC="${PM15MIN_RUNNER_SIGNAL_PREWARM_MIN_DELAY_SEC:-0}"
export PM15MIN_RUNNER_SIGNAL_PREWARM_MAX_DELAY_SEC="${PM15MIN_RUNNER_SIGNAL_PREWARM_MAX_DELAY_SEC:-3}"
export PM15MIN_RUNNER_SIGNAL_PREWARM_FINALIZE_CLOSED_BAR_WAIT_SEC="${PM15MIN_RUNNER_SIGNAL_PREWARM_FINALIZE_CLOSED_BAR_WAIT_SEC:-1.5}"
export PM15MIN_RUNNER_SIGNAL_PREWARM_FINALIZE_RETRY_INTERVAL_SEC="${PM15MIN_RUNNER_SIGNAL_PREWARM_FINALIZE_RETRY_INTERVAL_SEC:-0.05}"
export PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_MIN_DELAY_SEC="${PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_MIN_DELAY_SEC:-57}"
export PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_MAX_DELAY_SEC="${PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_MAX_DELAY_SEC:-59.9}"
export PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_FINALIZE_BRIDGE_SEC="${PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_FINALIZE_BRIDGE_SEC:-4.0}"
...
echo "Live Feature Incremental Tail Bars: $PM15MIN_LIVE_FEATURE_INCREMENTAL_BUILD_TAIL_BARS"
...
echo "Live Enforce Expected Closed Bar: $PM15MIN_LIVE_ENFORCE_EXPECTED_CLOSED_BAR"
echo "Live Expected Closed Bar Wait Sec: $PM15MIN_LIVE_EXPECTED_CLOSED_BAR_WAIT_SEC"
echo "Live Expected Closed Bar Poll Sec: $PM15MIN_LIVE_EXPECTED_CLOSED_BAR_POLL_SEC"
echo "Live Decision Depth Enforced: $PM15MIN_LIVE_DECISION_DEPTH_ENFORCED"
echo "Runner Signal Prewarm Min Delay Sec: $PM15MIN_RUNNER_SIGNAL_PREWARM_MIN_DELAY_SEC"
echo "Runner Signal Prewarm Max Delay Sec: $PM15MIN_RUNNER_SIGNAL_PREWARM_MAX_DELAY_SEC"
echo "Runner Signal Prewarm Finalize Closed-Bar Wait Sec: $PM15MIN_RUNNER_SIGNAL_PREWARM_FINALIZE_CLOSED_BAR_WAIT_SEC"
echo "Runner Signal Prewarm Finalize Retry Interval Sec: $PM15MIN_RUNNER_SIGNAL_PREWARM_FINALIZE_RETRY_INTERVAL_SEC"
echo "Runner Signal Prewarm Prepare Min Delay Sec: $PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_MIN_DELAY_SEC"
echo "Runner Signal Prewarm Prepare Max Delay Sec: $PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_MAX_DELAY_SEC"
echo "Runner Signal Prewarm Prepare->Finalize Bridge Sec: $PM15MIN_RUNNER_SIGNAL_PREWARM_PREPARE_FINALIZE_BRIDGE_SEC"
